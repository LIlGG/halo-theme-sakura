...
class Events {
  ...
  registerCopyEvent() {
    WindowEventProxy.addEventListener(
      ...
      () => {
        if (sakura.$toast) {
          sakura.$toast.create(sakura.translate("common.events.copy", "复制成功！<br>Copied to clipboard successfully!"), 2e3);
        }
      },
      2e3
    );
...
class Utils {
  ...
  registerHighlight() {
    ...
    preElements.forEach((preElement) => {
      ...
      __vitePreload(() => import("./assets/index-fc4eaf9a.js"), true ? [] : void 0).then(async (highlight) => {
        let lang = "";
  ...
  registerCopyCode() {
    ...
    codeElements.forEach((codeElement) => {
      ...
      __vitePreload(() => import("./assets/clipboard-0866f977.js").then((n) => n.c), true ? [] : void 0).then((module) => {
  ...
  registerToc() {
    ...
    tocContainerElements.forEach((tocContainerElement) => {
      __vitePreload(() => import("./assets/index-a448443f.js").then((n) => n.i), true ? [] : void 0).then((tocbot) => {
        var _a;
