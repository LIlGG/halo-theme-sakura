...
import { c as __vitePreload, i as instance } from "./assets/i18next-02f7db4d.js";
const _Util = class {
  /**
...
class Events {
  ...
  registerCopyEvent() {
    WindowEventProxy.addEventListener(
      ...
      () => {
        if (sakura.$toast) {
          sakura.$toast.create("复制成功！<br>Copied to clipboard successfully!", 2e3);
        }
      },
      2e3
    );
