...
import { g as getDefaultExportFromCjs } from "./assets/_commonjsHelpers-7a7fcd32.js";
...
class Events {
  ...
  registerHeaderEvent() {
    ...
    window.addEventListener("scroll", () => {
      ...
      __vitePreload(() => import("./assets/nprogress-92617843.js").then((n) => n.n), true ? ["assets/nprogress-92617843.js","assets/_commonjsHelpers-7a7fcd32.js"] : void 0).then((module) => {
...
class Utils {
  ...
  registerFixedAPlayer() {
    ...
    fetch(musicAPI).then((response) => response.json()).then((data) => {
      __vitePreload(() => import("./assets/APlayer.min-4c1eacf9.js").then((n) => n.A), true ? ["assets/APlayer.min-4c1eacf9.js","assets/_commonjsHelpers-7a7fcd32.js"] : void 0).then(async (module) => {
  ...
  wrapImageWithBox() {
    const contentElement = document.querySelector(".fancybox-content");
    ...
    __vitePreload(() => import("./assets/index.esm-ab99b29d.js"), true ? [] : void 0).then((module) => {
  ...
  registerCopyCode() {
    ...
    codeElements.forEach((codeElement) => {
      ...
      __vitePreload(() => import("./assets/clipboard-cc6c5a9e.js").then((n) => n.c), true ? ["assets/clipboard-cc6c5a9e.js","assets/_commonjsHelpers-7a7fcd32.js"] : void 0).then((module) => {
...
__decorateClass([
  documentFunction()
], Utils.prototype, "injectCommentStyle", 1);
__decorateClass([
  documentFunction(false)
  ...
  mountGlobalFunction() {
    ...
    if (isToast && !Object.getOwnPropertyDescriptor(sakura, "$toast")) {
      Object.defineProperty(sakura, "$toast", {
        value: new Toast({
          width: (_a = sakura.getThemeConfig("toast", "toast_width", Number)) == null ? void 0 : _a.valueOf(),
          height: (_b = sakura.getThemeConfig("toast", "toast_height", Number)) == null ? void 0 : _b.valueOf(),
          top: (_c = sakura.getThemeConfig("toast", "toast_top", String)) == null ? void 0 : _c.valueOf(),
          background: (_d = sakura.getThemeConfig("general", "theme_skin", String)) == null ? void 0 : _d.valueOf(),
          color: (_e = sakura.getThemeConfig("toast", "toast_color", String)) == null ? void 0 : _e.valueOf(),
          fontSize: (_f = sakura.getThemeConfig("toast", "toast_font_size", Number)) == null ? void 0 : _f.valueOf()
        }),
        writable: true,
        configurable: true,
        enumerable: false
      ...
      instance.use(Browser).use(Backend).init({
        ...
        interpolation: {
          format: function(value, format, lng, edit) {
            ...
            switch (format) {
              case "datetimeFormat":
                return I18nFormat.DateTimeFormat(value, lng, params == null ? void 0 : params.options, params == null ? void 0 : params.separator);
