import { c as __vitePreload } from "../assets/i18next-02f7db4d.js";
import { d as documentFunction, U as Util } from "../main.min.js";
import { c as commonjsGlobal, g as getDefaultExportFromCjs, a as getAugmentedNamespace } from "../assets/_commonjsHelpers-7a7fcd32.js";
...
var d3Cloud = function() {
  var size = [256, 256], text = cloudText, font = cloudFont, fontSize = cloudFontSize, fontStyle = cloudFontNormal, fontWeight = cloudFontNormal, rotate = cloudRotate, padding = cloudPadding, spiral = archimedeanSpiral, words = [], timeInterval = Infinity, event = dispatch("word", "end"), timer = null, random = Math.random, cloud2 = {}, canvas = cloudCanvas;
...
class Tags {
  ...
  async registerTagsWordCloud() {
    ...
    const d3 = await __vitePreload(() => import("../assets/index-8c1129ff.js"), true ? [] : void 0);
