...
class Post {
  ...
  registerWordCountToast() {
    ...
    if (postWordCount > 0) {
      ...
      if (window.innerWidth > 860) {
        ...
        remind = ((_a = sakura.getThemeConfig("post", `post_word_count_toast_${type.toLowerCase()}`, String)) == null ? void 0 : _a.valueOf()) || sakura.translate("post.word_count_toast.remind", defaultRemind[type.toLowerCase()], {
  ...
  registerEditTimeToast() {
    ...
    if (window.innerWidth > 860) {
      ...
      remind = ((_a = sakura.getThemeConfig("post", `post_edit_time_toast_${type.toLowerCase()}`, String)) == null ? void 0 : _a.valueOf()) || sakura.translate("post.edit_time_toast.remind", defaultRemind[type.toLowerCase()], {
        context: type.toLowerCase()
      });
    }
