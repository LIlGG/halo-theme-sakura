import { d as documentFunction, _ as __vitePreload } from "../main.min.js";
...
class Photos {
  ...
  registerMasonryLayout() {
    ...
    __vitePreload(() => import("../assets/isotope-1c156680.js").then((n) => n.i), true ? [] : void 0).then((module) => {
      ...
      galleryElement == null ? void 0 : galleryElement.querySelectorAll("img.lazyload").forEach((img) => {
        img.addEventListener("load", () => {
          ...
          (_a = masonryContainerElement.querySelector(".photos-content")) == null ? void 0 : _a.classList.remove("loading");
        });
      });
      const galleryFilterbarElement = masonryContainerElement == null ? void 0 : masonryContainerElement.querySelector("#gallery-filter");
      const galleryFilterbarItemsElement = galleryFilterbarElement == null ? void 0 : galleryFilterbarElement.querySelectorAll("li a");
      ...
      const gridChangeElements = masonryContainerElement == null ? void 0 : masonryContainerElement.querySelectorAll("#grid-changer a");
