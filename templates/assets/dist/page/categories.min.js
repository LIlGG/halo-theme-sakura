...
class Categories {
  ...
  async registerCategoryRadarChart() {
    ...
    const echarts = await __vitePreload(() => import("../assets/core-f286fa79.js"), true ? ["assets/core-f286fa79.js","assets/Axis-36931291.js","assets/graphic-33d55267.js","assets/createSeriesData-dc0184ee.js"] : void 0);
    await __vitePreload(() => import("../assets/charts-b5b7f256.js"), true ? ["assets/charts-b5b7f256.js","assets/graphic-33d55267.js","assets/createSeriesData-dc0184ee.js","assets/Axis-36931291.js","assets/customGraphicKeyframeAnimation-dd930469.js"] : void 0).then((module) => {
      echarts.use([module.RadarChart]);
    });
    await __vitePreload(() => import("../assets/components-2bc687f6.js"), true ? ["assets/components-2bc687f6.js","assets/customGraphicKeyframeAnimation-dd930469.js","assets/Axis-36931291.js","assets/graphic-33d55267.js"] : void 0).then((module) => {
      echarts.use([
        module.TitleComponent,
        module.TooltipComponent
      ]);
    });
    await __vitePreload(() => import("../assets/renderers-2dbb20da.js"), true ? ["assets/renderers-2dbb20da.js","assets/graphic-33d55267.js"] : void 0).then((module) => {
