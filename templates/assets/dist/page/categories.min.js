...
class Categories {
  ...
  async registerCategoryRadarChart() {
    ...
    const echarts = await __vitePreload(() => import("../assets/core-55e46693.js"), true ? ["assets/core-55e46693.js","assets/Axis-1d2b148d.js","assets/graphic-c958e8df.js","assets/createSeriesData-47a0bdc8.js"] : void 0);
    await __vitePreload(() => import("../assets/charts-9b126745.js"), true ? ["assets/charts-9b126745.js","assets/graphic-c958e8df.js","assets/createSeriesData-47a0bdc8.js","assets/Axis-1d2b148d.js","assets/customGraphicKeyframeAnimation-e508d217.js"] : void 0).then((module) => {
      echarts.use([module.RadarChart]);
    });
    await __vitePreload(() => import("../assets/components-184f0ea1.js"), true ? ["assets/components-184f0ea1.js","assets/customGraphicKeyframeAnimation-e508d217.js","assets/Axis-1d2b148d.js","assets/graphic-c958e8df.js"] : void 0).then((module) => {
      echarts.use([
        module.TitleComponent,
        module.TooltipComponent
      ]);
    });
    await __vitePreload(() => import("../assets/renderers-937e32c4.js"), true ? ["assets/renderers-937e32c4.js","assets/graphic-c958e8df.js"] : void 0).then((module) => {
