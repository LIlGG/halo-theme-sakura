...
class Categories {
  ...
  async registerCategoryRadarChart() {
    ...
    const echarts = await __vitePreload(() => import("../assets/core-56c62a0c.js"), true ? [] : void 0);
    await __vitePreload(() => import("../assets/charts-b88cff0f.js"), true ? [] : void 0).then((module) => {
      echarts.use([module.RadarChart]);
    });
    await __vitePreload(() => import("../assets/components-cc42923a.js"), true ? [] : void 0).then((module) => {
      echarts.use([
        module.TitleComponent,
        module.TooltipComponent
      ]);
    });
    await __vitePreload(() => import("../assets/renderers-c68baf44.js"), true ? [] : void 0).then((module) => {
