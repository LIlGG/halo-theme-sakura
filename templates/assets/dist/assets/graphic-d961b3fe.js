...
export {
  ...
  guid as aA,
  lum as aB,
  DARK_MODE_THRESHOLD as aC,
  isStringSafe as aD,
  LRU$1 as aE,
  isArrayLike as aF,
  isGradientObject as aG,
  applyTransform as aH,
  min$1 as aI,
  max$1 as aJ,
  distance as aK,
  add as aL,
  subPixelOptimizeLine as aM,
  cubicSubdivide as aN,
  cubicDerivativeAt as aO,
  identity as aP,
  mul as aQ,
  subPixelOptimize as aR,
  Transformable$1 as aS,
  invert as aT,
  subPixelOptimizeRect as aU,
  trim as aV,
  isTypedArray as aW,
  setAsPrimitive as aX,
  slice as aY,
  windingLine as aZ,
  getBoundingRect as a_,
  sub as aa,
  len as ab,
  set as ac,
  copy$1 as ad,
  ...
  hasOwn as as,
  isCanvasEl as at,
  transformCoordWithViewport as au,
  Eventful$1 as av,
  REDRAW_BIT as aw,
  requestAnimationFrame$1 as ax,
  Animator$1 as ay,
  Element$1 as az,
  bind as b,
  TSpan$1 as b0,
