...
var Util = {
  ...
  * @return zh、cn 等
  */
  getNavLangSub: function getNavLangSub() {
    var currentLang = navigator.language; // 只获取前两个字符

    currentLang = currentLang.substr(0, 2); //判断IE浏览器使用语言
   ...
   */
  setCookie: function setCookie(key, value, days) {
   ...
   */
  setLocalStorage: function (_setLocalStorage) {
    function setLocalStorage(_x, _x2) {
      return _setLocalStorage.apply(this, arguments);
    }

    setLocalStorage.toString = function () {
      return _setLocalStorage.toString();
    };

    return setLocalStorage;
  }(function (key, value) {
    var expires = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 3600;
    var keyVE = key + Util._version;
    var date = new Date();
   ...
   */
  _loadRes: function _loadRes(type, url, callback) {
    var dom,
   ...
   */
  getNearestKeyframe: function getNearestKeyframe(keyframesIndex, milliseconds) {
   ...
   */
  _search: function _search(list, value) {
    var idx = 0;
